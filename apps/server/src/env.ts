import type { ThinkingMCP, ThreadSyncWorker, WorkflowRunner, WhyWireDB, WhyWireMCP } from './main';
import type { ShardRegistry, WhyWireAgent, WhyWireDriver } from './routes/agent';

import { env as _env } from 'cloudflare:workers';
import type { QueryableHandler } from 'dormroom';

export type ZeroEnv = {
  WHYWIRE_DRIVER: DurableObjectNamespace<WhyWireDriver & QueryableHandler>;
  SHARD_REGISTRY: DurableObjectNamespace<ShardRegistry & QueryableHandler>;
  WHYWIRE_DB: DurableObjectNamespace<WhyWireDB>;
  WHYWIRE_AGENT: DurableObjectNamespace<WhyWireAgent>;
  WHYWIRE_MCP: DurableObjectNamespace<WhyWireMCP & QueryableHandler>;
