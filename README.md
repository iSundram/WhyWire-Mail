<p align="center">
  <picture>
    ...
    <img src="apps/mail/public/black-icon.svg" alt="WhyWire Mail Logo" width="64" style="background-color: #000; padding: 10px;"/>
  </picture>
</p>

# WhyWire Mail

An Open-Source AI-Powered Email Client for the Future of Email

## What is WhyWire Mail?

WhyWire Mail is an open-source AI email solution that gives users the power to **self-host** their own email app while also integrating external services like Gmail and other email providers. Our goal is to modernize and improve emails through AI agents to truly modernize emails.

## Why WhyWire Mail?

Most email services today are either **closed-source**, **data-hungry**, or **too complex to self-host**.
WhyWire Mail is different:

- ✅ **Open-Source** – No hidden agendas, fully transparent.
- 🦾 **AI Driven** - Enhance your emails with Agents & LLMs.
- 🔒 **Data Privacy First** – Your emails, your data. WhyWire Mail does not track, collect, or sell your data in any way. Please note: while we integrate with external services, the data passed through them is not under our control and falls under their respective privacy policies and terms of service.
...
WhyWire Mail is built with modern and reliable technologies:
...
You can set up WhyWire Mail in two ways:
...
1. **Clone and Install**
   ...
   git clone https://github.com/your-org/WhyWire-Mail.git
   cd WhyWire-Mail
